  ...
  _createClass(Speck, [{
    ...
    value: function toJSON() {
      ...
      var rawData = Object.keys(this.data).reduce(function (data, field) {
        return Object.assign(data, _defineProperty({}, field, _this2._fetchChild(_this2.data[field])));
      }, {});
    ...
    value: function getErrors() {
      var errors = Object.assign({}, this._validate());
    ...
    value: function validateContext(context) {
      ...
      var contextErrors = Object.assign({}, this.errors);
      ...
      return errors.reduce(function (newError, errorField) {
